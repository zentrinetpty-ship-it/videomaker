...
export const DesktopSidebar = ({
    ...
    return (
        <motion.div
            className={cn(
                "h-full px-4 py-4 hidden md:flex md:flex-col bg-[#0a0a0a] w-[300px] flex-shrink-0 border-r border-white/[0.08]",
                className
            )}
            animate={{
...
export const MobileSidebar = ({
    ...
    return (
        <>
            <div
                className={cn(
                    "h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-[#0a0a0a] w-full border-b border-white/[0.08]"
                )}
                {...props}
            >
